...
/**
 * Home object for domain model class ClientStatus.
 * @see .ClientStatus
 * @author Hibernate Tools
 */
public class ClientStatusHome {

	private static final Log log = LogFactory.getLog(ClientStatusHome.class);
	...
	public void persist(ClientStatus transientInstance) {
		log.debug("persisting ClientStatus instance");
		try {
	...
	public ClientStatus merge(ClientStatus detachedInstance) {
		...
		try {
			ClientStatus result = (ClientStatus) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public ClientStatus findById(java.lang.String id) {
		log.debug("getting ClientStatus instance with id: " + id);
		try {
			ClientStatus instance = (ClientStatus) sessionFactory.getCurrentSession().get("ClientStatus", id);
			if (instance == null) {
	...
	public List findByExample(ClientStatus instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("ClientStatus")
